...
function buildPrintableReportHtml(report, items) {
  ...
  const runtime = status.agent_runtime_label || status.agent_runtime || 'UiPath external coded agent';
  const model = status.reasoning_engine || 'FraudCase AI agent';
  const evidence = status.evidence_engine || 'UiPath Context Grounding';
      ...
      <body>
        <main class="report-shell">
          ...
          <section class="meta-grid">
            ...
            <div><span>Evidence</span><strong>${escHtml(evidence)}</strong></div>
        ...
        <main class="page">
          ...
          <section class="parties">
            ...
            <div class="box">
              ...
              <div class="subtle">Generated by ${escHtml(state.appStatus?.reasoning_engine || 'FraudCase AI agent')}</div>
            </div>
          </section>
